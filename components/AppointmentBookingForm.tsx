...
const toApiDateFormat = (value: string) => {
...
export default function AppointmentBookingForm() {
  ...
  const openCalendarPicker = () => {
    const dateInput = calendarInputRef.current;
        ...
        <div className="appointment-form-box">
          <form className="appointment-form" onSubmit={handleSubmit}>
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                <label htmlFor="appointment-date-display">Preferred Date</label>
                <input
                ...
                <input
                  ...
                  onChange={(event) => {
                    ...
                    handleChange('preferredDate', toApiDateFormat(value));
                  }}
                  className="sr-only"
                  tabIndex={-1}
                  aria-hidden="true"
